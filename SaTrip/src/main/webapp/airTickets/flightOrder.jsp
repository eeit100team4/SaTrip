...
//價格
            var cell7=$("<span></span>").text(value.AirItineraryPricingInfo[0].PTC_FareBreakdowns.PTC_FareBreakdown[0].PassengerFare.TotalFare.Amount);
            ...
            var cell10=$("<div></div>").html("<p>每人含稅</p><button type='button' class='btn btn_yell' id="+name+" onclick='sendDetails()'>訂位</button>");
						...
						xmlhttp.onload=function(){
							 xmlDoc = xmlhttp.responseXML;
								...
								te=te.substring(te.length-4,te.length);
							 	res=res.replace(new RegExp(ss,"g"),"").replace(new RegExp(te,"g"),"\"");
							 	emp=JSON.parse(res);
							 list();
							 page();
						}
...
// 				    dataType:"json",
				    success : function(response) {
				        alert('Success');
				        window.location.assign("http://localhost:8080/SaTrip/airTickets/test.jsp");
				    },
				    error : function() {
				        alert('fail');
				    }
						...
						<div class="page_btn clear">
							...
							<div class="main123">
								<div class="item123">
									...
									<table class="clear123" width=100% align="center"
										style="border: 5px solid red; background-color: white">

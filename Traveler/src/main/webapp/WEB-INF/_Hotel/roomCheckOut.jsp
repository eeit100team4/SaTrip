...
//               console.log($("#TradeDesc").val()+","+ $("#TotalAmount").val()+","+$("#MerchantTradeDate").val());
              var partOne="ChoosePayment=Credit&ClientBackURL=http://localhost:8080/Traveler/_Hotel/OrderFinish&CreditInstallment=&EncryptType=1&InstallmentAmount=&ItemName=飯店房間&MerchantID=2000132&MerchantTradeDate="+currentDateTime;	  
              var  partTwo= "&MerchantTradeNo="+rando+"&PaymentType=aio&Redeem=&ReturnURL=http://localhost:8080/Traveler/_Hotel/OrderFinish&StoreID=&TotalAmount=4500&TradeDesc=飯店訂單"
...
<input type="hidden" name="ReturnURL" value="http://localhost:8080/Traveler/_Hotel/OrderFinish" /><br />
...
<input type="hidden" name="ClientBackURL" value="http://localhost:8080/Traveler/_Hotel/OrderFinish" /><br />

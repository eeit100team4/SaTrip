...
//               console.log($("#TradeDesc").val()+","+ $("#TotalAmount").val()+","+$("#MerchantTradeDate").val());
              var partOne="ChoosePayment=Credit&ClientBackURL=http://localhost:8080/Traveler/_Hotel/OrderFinish2&CreditInstallment=&EncryptType=1&InstallmentAmount=&ItemName=飯店房間&MerchantID=2000132&MerchantTradeDate="+currentDateTime;	  
              var  partTwo= "&MerchantTradeNo="+rando+"&PaymentType=aio&Redeem=&ReturnURL=http://localhost:8080/Traveler/_Hotel/OrderFinish2&StoreID=&TotalAmount=6500&TradeDesc=飯店訂單"
					...
					<div class="col-lg-12 text-center">
						...
						<div style="margin-top:20px;" ><h2><span class="label label-warning"></span></h2></div>
							<table class="table table-bordered table-condensed">
								...
								<tr class="warning">
									<td>訂單價格：</td>
									<td style="color:red">NT$ 6,500</td>
								</tr>									
							</table>
						<br>
						<br>
...
<!--  TotalAmount 交易金額: -->
<input type="hidden" name="TotalAmount" id="TotalAmount" value="6500" /><br />
...
<input type="hidden" name="ReturnURL" value="http://localhost:8080/Traveler/_Hotel/OrderFinish2" /><br />
...
<input type="hidden" name="ClientBackURL" value="http://localhost:8080/Traveler/_Hotel/OrderFinish2" /><br />

			...
			<div class="col-8">
					...
					<div class="carousel-inner">
						...
						<div class="carousel-item active">
							<img class="d-block w-60"
								src="/Traveler/images/hotelPic/korFRA4.jpg" alt="First slide">
						</div>
						...
						<div class="carousel-item">
							<img class="d-block w-100"
								src="/Traveler/images/hotelPic/korFRA1.jpg" alt="Third slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100"
				...
				<table class="table">
					<thead style="width: 60px">
						<tr>
							<th style="width: 60px" scope="col"><h3>房型</h3></th>
							<th scope="col"><h3>選項</h3></th>
							<th scope="col"><h3>會員福利</h3></th>
							<th scope="col"><h3>今天價格</h3></th>
							<th scope="col"></th>
						</tr>
					</thead>
					<tbody>						
				...
				<form action="DisplayRoom" method="get">
					<div class="card ">
						...
						<div class="card-body">
							...
							<h1 class="card-title" style="color: red">NT：6,800</h1>
							<p class="card-text"></p>
							<a href="OrderRoom1" class="btn btn-primary" name="">立即訂房</a>
						</div>
					</div>
				</form>
				<br> <br>
